        ...
        <b-colxx xxs="12" md="3">
          ...
          <b-card v-else>
            <h5>Você precisa anexar: </h5>
              <router-link v-if="!currentOrder.face" to="/admin/make/face">Imagem da face</router-link><br>
              <router-link v-if="!currentOrder.recipe" to="/admin/make/recipe">Imagem da receita</router-link>
          </b-card>
        </b-colxx>
        ...
        <b-colxx xxs="12" md="6">
          <b-card no-body>
            ...
            <div v-else>
              ...
              <router-link to="/admin/make/products">Clique para selecionar</router-link>
            </div>
          </b-card>
    ...
    methods: {
      ...
      sendInfo: async function(){
          ...
          if(data.status == 'success') {
              ...
              this.clearCart();
              this.$router.push('/admin/make/success');
          }else{
