      ...
      <b-colxx xxs="12">
        <b-card class="mb-4" title="Selecione o item">
          ...
          <b-row v-else class="align-items-center justify-content-center text-center">
            <h5>Você precisa inserir uma empresa para continuar. <router-link style="text-decoration:underline" to="/app/order/information">Inserir empresa</router-link> </h5>
          </b-row>
        </b-card>
      </b-colxx>
    </b-row>
